    ...
    <div className="container" style={{ padding: "20px" }}>
      ...
      <div className="max-w-xl mx-auto bg-white p-6 rounded-lg shadow-md space-y-6">
        ...
        <div>
          <label>Price:</label>
          <input
            class="w-full px-4 py-2 border border border-gray-700 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none focus:border-blue-500 text-gray-700"
            type="number"
            name="price"
